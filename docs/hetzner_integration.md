...
The project uses a combined inventory approach located in `ansible/inventory/`:
...
- **State Persistence**: Saves discovered infrastructure settings to `ansible/state/{{ inventory_hostname }}/hetzner/` as JSON files.
