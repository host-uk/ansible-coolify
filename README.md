...
3. Run the playbook with the desired limit: 
   - Production: `ansible-playbook -l production playbooks/playbook_install_coolify.yml`
   - Development: `ansible-playbook -l development playbooks/playbook_install_coolify.yml`
